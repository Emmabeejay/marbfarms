<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AdminPage.aspx.cs" Inherits="Aquafarms.Admin.AdminPage" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <tr>
            ...
            <td>
                <asp:DropDownList ID="DropDownAddCategory" runat="server" 
                    ItemType="Aquafarms.Models.Category" 
    ...
    <table>
        <tr>
            ...
            <td><asp:DropDownList ID="DropDownRemoveProduct" runat="server" ItemType="Aquafarms.Models.Product" 
